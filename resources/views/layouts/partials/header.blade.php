            ...
            <ul class="right">
                ...
                <li><a class="dropdown-trigger" href="javascript: void(0);" data-target="user_dropdown"><img src="../../assets/images/users/2.jpg" alt="user" class="circle profile-pic"></a>
                    <ul id="user_dropdown" class="mailbox dropdown-content dropdown-user">
                        <li>
                            <div class="dw-user-box">
                                ...
                                <div class="u-text">
                                    <h4>Steve Harvey</h4>
                                    <p>steve@gmail.com</p>
                                    <a class="waves-effect waves-light btn-small red white-text">Voir Le Profil</a>
                                </div>
                            </div>
                        </li>
                        ...
                        <li role="separator" class="divider"></li>
                        <li><a href="#"><i class="material-icons">settings</i> Parametres</a></li>
                        <li role="separator" class="divider"></li>
                        <li><a href="#"><i class="material-icons">power_settings_new</i> Se Deconnecter </a></li>
                    </ul>
                </li>
            </ul>
            <!-- ============================================================== -->
