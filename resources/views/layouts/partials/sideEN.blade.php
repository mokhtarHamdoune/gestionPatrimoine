        ...
        <li>
            <ul class="collapsible">
                ...
                <li>
                 ...
                 <li>
                    <a href="javascript: void(0);" class="collapsible-header has-arrow"><i class="material-icons">equalizer</i><span class="hide-menu"> Consulter Emploi  </span></a>
                    <div class="collapsible-body">
                       <!--  <ul>
                 ...
                 <li>
                    <a href="javascript: void(0);" class="collapsible-header has-arrow"><i class="material-icons">equalizer</i><span class="hide-menu">Contacter SG</span></a>
                    <div class="collapsible-body">
                        <ul>
                            <li><a href="{{route('declarer.index',1)}}"><i class="material-icons">photo_size_select_small</i><span class="hide-menu">Declarer une panne</span></a></li>
                            <li><a href="#"><i class="material-icons">picture_in_picture</i><span class="hide-menu">Envoyer une message</span></a></li>
                            <!-- <li><a href="sidebar-type-overlay.html"><i class="material-icons">low_priority</i><span class="hide-menu">Overlay Sidebar</span></a></li>
                            <li><a href="sidebar-type-fullsidebar.html"><i class="material-icons">present_to_all</i><span class="hide-menu">Full Sidebar</span></a></li>
                            <li><a href="../horizontal/index.html"><i class="material-icons">power_input</i><span class="hide-menu">Horizontal Sidebar</span></a></li> -->
                        </ul>
